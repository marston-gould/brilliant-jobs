import{a as i,j as e}from"./react-vendor.js";import{s as j}from"./providers.js";const B=i.createContext({toast:()=>{}});function it({children:r}){const[s,a]=i.useState([]),c=i.useCallback((p,u="info",x=3e3)=>{const m=crypto.randomUUID();a(l=>[...l,{id:m,text:p,type:u,duration:x}])},[]),d=i.useCallback(p=>{a(u=>u.filter(x=>x.id!==p))},[]);i.useEffect(()=>{if(s.length===0)return;const p=s[0];if(!p)return;const u=setTimeout(()=>d(p.id),p.duration||3e3);return()=>clearTimeout(u)},[s,d]),i.useEffect(()=>{window.__bjToast=c},[c]);const n={success:"bg-green text-white",error:"bg-red text-white",info:"bg-accent text-white"};return e.jsxs(B.Provider,{value:{toast:c},children:[r,e.jsx("div",{className:"fixed bottom-4 right-4 z-50 flex flex-col gap-2 pointer-events-none",style:{maxWidth:360},children:s.map(p=>e.jsx("div",{className:`pointer-events-auto px-4 py-2.5 rounded-lg shadow-lg text-[13px] font-medium animate-[slideIn_0.2s_ease] ${n[p.type]}`,onClick:()=>d(p.id),style:{cursor:"pointer"},children:p.text},p.id))})]})}/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const L=(...r)=>r.filter((s,a,c)=>!!s&&s.trim()!==""&&c.indexOf(s)===a).join(" ").trim();/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=r=>{const s=P(r);return s.charAt(0).toUpperCase()+s.slice(1)};/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=r=>{for(const s in r)if(s.startsWith("aria-")||s==="role"||s==="title")return!0;return!1};/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R=i.forwardRef(({color:r="currentColor",size:s=24,strokeWidth:a=2,absoluteStrokeWidth:c,className:d="",children:n,iconNode:p,...u},x)=>i.createElement("svg",{ref:x,...U,width:s,height:s,stroke:r,strokeWidth:c?Number(a)*24/Number(s):a,className:L("lucide",d),...!n&&!T(u)&&{"aria-hidden":"true"},...u},[...p.map(([m,l])=>i.createElement(m,l)),...Array.isArray(n)?n:[n]]));/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const t=(r,s)=>{const a=i.forwardRef(({className:c,...d},n)=>i.createElement(R,{ref:n,iconNode:s,className:L(`lucide-${D(z(r))}`,`lucide-${r}`,c),...d}));return a.displayName=z(r),a};/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const I=[["path",{d:"M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z",key:"3c2336"}],["line",{x1:"15",x2:"9",y1:"9",y2:"15",key:"f7djnv"}],["line",{x1:"9",x2:"15",y1:"9",y2:"15",key:"1shsy8"}]],dt=t("badge-x",I);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const J=[["path",{d:"M10.268 21a2 2 0 0 0 3.464 0",key:"vwvbt9"}],["path",{d:"M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326",key:"11g9vi"}]],pt=t("bell",J);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const O=[["path",{d:"M10 2v8l3-3 3 3V2",key:"sqw3rj"}],["path",{d:"M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20",key:"k3hazp"}]],ht=t("book-marked",O);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const re=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],Nt=t("copy",re);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ne=[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]],jt=t("credit-card",ne);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ce=[["line",{x1:"12",x2:"12",y1:"2",y2:"22",key:"7eqyqh"}],["path",{d:"M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6",key:"1b0p4s"}]],$t=t("dollar-sign",ce);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ie=[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]],Ct=t("external-link",ie);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],zt=t("eye",le);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=[["path",{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z",key:"1oefj6"}],["path",{d:"M14 2v5a1 1 0 0 0 1 1h5",key:"wfsgrz"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]],St=t("file-text",de);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Me=[["path",{d:"M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0",key:"1r0f0z"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]],It=t("map-pin",Me);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ne=[["path",{d:"M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z",key:"18887p"}]],Jt=t("message-square",Ne);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const je=[["rect",{width:"20",height:"14",x:"2",y:"3",rx:"2",key:"48i651"}],["line",{x1:"8",x2:"16",y1:"21",y2:"21",key:"1svkeh"}],["line",{x1:"12",x2:"12",y1:"17",y2:"21",key:"vw1qmm"}]],Ot=t("monitor",je);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $e=[["path",{d:"M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401",key:"kfwtm"}]],Kt=t("moon",$e);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ce=[["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"M2.586 16.726A2 2 0 0 1 2 15.312V8.688a2 2 0 0 1 .586-1.414l4.688-4.688A2 2 0 0 1 8.688 2h6.624a2 2 0 0 1 1.414.586l4.688 4.688A2 2 0 0 1 22 8.688v6.624a2 2 0 0 1-.586 1.414l-4.688 4.688a2 2 0 0 1-1.414.586H8.688a2 2 0 0 1-1.414-.586z",key:"2d38gg"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]],Wt=t("octagon-x",Ce);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ze=[["path",{d:"M5.8 11.3 2 22l10.7-3.79",key:"gwxi1d"}],["path",{d:"M4 3h.01",key:"1vcuye"}],["path",{d:"M22 8h.01",key:"1mrtc2"}],["path",{d:"M15 2h.01",key:"1cjtqr"}],["path",{d:"M22 20h.01",key:"1mrys2"}],["path",{d:"m22 2-2.24.75a2.9 2.9 0 0 0-1.96 3.12c.1.86-.57 1.63-1.45 1.63h-.38c-.86 0-1.6.6-1.76 1.44L14 10",key:"hbicv8"}],["path",{d:"m22 13-.82-.33c-.86-.34-1.82.2-1.98 1.11c-.11.7-.72 1.22-1.43 1.22H17",key:"1i94pl"}],["path",{d:"m11 2 .33.82c.34.86-.2 1.82-1.11 1.98C9.52 4.9 9 5.52 9 6.23V7",key:"1cofks"}],["path",{d:"M11 13c1.93 1.93 2.83 4.17 2 5-.83.83-3.07-.07-5-2-1.93-1.93-2.83-4.17-2-5 .83-.83 3.07.07 5 2Z",key:"4kbmks"}]],Zt=t("party-popper",ze);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Se=[["path",{d:"M13 21h8",key:"1jsn5i"}],["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}]],Gt=t("pen-line",Se);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pe=[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]],ra=t("smartphone",Pe);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ue=[["path",{d:"M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z",key:"1s2grr"}],["path",{d:"M20 2v4",key:"1rf3ol"}],["path",{d:"M22 4h-4",key:"gwowj6"}],["circle",{cx:"4",cy:"20",r:"2",key:"6kqj1y"}]],na=t("sparkles",Ue);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ie=[["path",{d:"M16 7h6v6",key:"box55l"}],["path",{d:"m22 7-8.5 8.5-5-5L2 17",key:"1t1m79"}]],da=t("trending-up",Ie);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Je=[["path",{d:"M12 3v12",key:"1x0j5s"}],["path",{d:"m17 8-5-5-5 5",key:"7q97r8"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}]],pa=t("upload",Je);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oe=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],ha=t("user",Oe);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ge=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]],ua=t("zap",Ge),Xe={primary:"bg-accent text-white border-accent hover:opacity-90 active:opacity-80",secondary:"bg-bg-card text-text border-border hover:border-border-hover hover:text-text active:bg-bg-hover",ghost:"bg-transparent text-text-dim border-transparent hover:bg-bg-hover hover:text-text active:bg-bg-input",danger:"bg-red text-white border-red hover:opacity-90 active:opacity-80"},Qe={sm:"px-3.5 py-[7px] text-xs rounded-md gap-1.5",md:"px-5 py-2.5 text-[13px] rounded-lg gap-2 font-semibold",lg:"px-8 py-3.5 text-[15px] rounded-lg gap-2 font-semibold"};function xa({variant:r="secondary",size:s="md",loading:a=!1,icon:c,fullWidth:d=!1,disabled:n,className:p="",children:u,...x}){const m="inline-flex items-center justify-center border font-medium transition-all cursor-pointer select-none",l=n||a?"opacity-50 cursor-not-allowed":"",k=d?"w-full":"";return e.jsxs("button",{className:`${m} ${Xe[r]} ${Qe[s]} ${l} ${k} ${p}`,disabled:n||a,...x,children:[a?e.jsx("span",{className:"inline-block w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin"}):c?e.jsx("span",{className:"flex-shrink-0",children:c}):null,u]})}const Ye={default:"bg-bg-card border border-border",elevated:"bg-bg-card border border-border shadow-md",outline:"bg-transparent border border-border",inset:"bg-bg-input border border-border"},et={none:"",sm:"p-3",md:"p-6",lg:"p-6"};function ma({variant:r="default",padding:s="md",as:a="div",className:c="",children:d,...n}){return e.jsx(a,{className:`rounded-xl ${Ye[r]} ${et[s]} ${c}`,...n,children:d})}const tt={default:"bg-bg-input text-text-dim border-border",secondary:"bg-bg-card text-text-muted border-border/50",success:"bg-green-dim text-green border-green/20",warning:"bg-warm-dim text-warm border-warm/20",error:"bg-red-dim text-red border-red/20",info:"bg-accent-dim text-accent border-accent/20",purple:"bg-purple-dim text-purple border-purple/20"},at={sm:"px-2.5 py-[3px] text-[11px]",md:"px-2 py-0.5 text-xs"};function ba({variant:r="default",size:s="md",dot:a=!1,className:c="",children:d,...n}){return e.jsxs("span",{className:`inline-flex items-center gap-1 font-semibold rounded-lg border ${tt[r]} ${at[s]} ${c}`,...n,children:[a&&e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-current flex-shrink-0"}),d]})}const st={sm:"max-w-sm",md:"max-w-md",lg:"max-w-lg",xl:"max-w-2xl"};function A({open:r,onClose:s,title:a,size:c="md",children:d,footer:n}){const p=i.useRef(null),u=i.useRef(null);i.useEffect(()=>{r?(u.current=document.activeElement,p.current?.focus()):u.current?.focus()},[r]);const x=i.useCallback(l=>{l.key==="Escape"&&(l.stopPropagation(),s())},[s]),m=i.useCallback(l=>{l.target===l.currentTarget&&s()},[s]);return r?e.jsxs("div",{className:"fixed inset-0 z-40 flex items-center justify-center p-4 animate-modal-fade",role:"presentation",onClick:m,children:[e.jsx("div",{className:"absolute inset-0 bg-black/50","aria-hidden":"true",onClick:s}),e.jsxs("dialog",{ref:p,open:!0,className:`
          relative z-50 w-full ${st[c]}
          bg-bg-card border border-border rounded-lg
          shadow-xl
          animate-modal-slide
          max-h-[85vh] overflow-hidden flex flex-col
        `,role:"dialog","aria-modal":"true","aria-labelledby":a?"modal-title":void 0,onKeyDown:x,tabIndex:-1,children:[a&&e.jsxs("div",{className:"flex items-center justify-between px-5 py-4 border-b border-border",children:[e.jsx("h2",{id:"modal-title",className:"text-lg font-semibold text-text",children:a}),e.jsx("button",{onClick:s,className:"text-text-faint hover:text-text p-1 rounded-md hover:bg-bg-hover transition-all","aria-label":"Close dialog",children:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:e.jsx("path",{d:"M4 4l8 8M12 4l-8 8"})})})]}),e.jsx("div",{className:"flex-1 overflow-y-auto px-5 py-4",children:d}),n&&e.jsx("div",{className:"flex items-center justify-end gap-2 px-5 py-3 border-t border-border",children:n})]})]}):null}const ot={feed:{title:"Jobs Feed",steps:["Check one or more saved searches in the sidebar to search jobs.","Shift+click column headers for multi-column sorting.","Click a job title to open the full description and apply.","Colored number badges show which filter matched each job.","Use the keyword insights panel to see term frequency and resume match scores."]},tuning:{title:"Search Tuning",steps:["Set global rules that apply across ALL your saved searches.","Location rules: US-only toggle and city/country exclusions.",'Title exclusions: remove common false positives (e.g. "intern").',"Company exclusions: block specific employers or industries.","Level hierarchy: define seniority levels and their keywords for automatic job ranking."]},pipeline:{title:"Pipeline",steps:["Track every job from saved through offer/rejection.","Click stage headers to collapse/expand sections.","Use the Move dropdown on any row to advance jobs through stages.","Stats at top show response rates and days-to-response.","Filter by saved search using the dropdown above the stages."]},resumes:{title:"Resumes",steps:["Upload a resume for each role type or seniority level you target.","Assign a level (Director, Manager, etc.) to each resume.","Click filter pills on each card to assign resumes to your saved searches.","When you apply, the matching resume is automatically selected.","Keyword extraction shows how well each resume matches job descriptions."]},applications:{title:"Applications",steps:["Queue tab: manage pending applications (manual add, batch process).","Rules tab: set default application mode (Manual, Notify, Auto) and auto-apply rules.","Notifications tab: configure email/SMS preferences for every alert type.","Verify your phone to unlock SMS notifications and escalation.","Set escalation rules: unanswered emails auto-escalate to SMS after your timeout.","Override notification settings per saved search for targeted control.","History tab: full audit trail of applications and notification delivery log."]},stats:{title:"Stats",steps:["View aggregated analytics across all your job search activity.","Track application volume, response rates, and pipeline velocity.","Compare performance across different filters and resume versions."]},"get-started":{title:"Setup",steps:["Connect the Chrome extension to scan your LinkedIn network.","Your connections are matched against our job database.","Jobs where you have an inside contact are flagged for priority."]},settings:{title:"Settings",steps:["Manage your account, notification preferences, and data.","Export or delete your data at any time."]},subscription:{title:"Subscription",steps:["View your current plan and usage.","Upgrade to Pro for auto-apply, advanced analytics, and more."]},notifications:{title:"Notification Center",steps:["Preferences tab: toggle email and SMS per notification type.","Verify your phone number to enable SMS alerts.","Log tab: view delivery history for all notifications."]},"interview-prep":{title:"Interview Prep",steps:["Browse the question bank by category.","Practice mode lets you record and review your answers.","AI scoring gives feedback on structure and content."]}};function rt({helpId:r,onClose:s}){const a=i.useRef(null);if(i.useEffect(()=>{if(!r)return;function d(p){a.current&&!a.current.contains(p.target)&&s()}const n=setTimeout(()=>document.addEventListener("click",d),50);return()=>{clearTimeout(n),document.removeEventListener("click",d)}},[r,s]),i.useEffect(()=>{if(!r)return;function d(n){n.key==="Escape"&&s()}return document.addEventListener("keydown",d),()=>document.removeEventListener("keydown",d)},[r,s]),!r)return null;const c=ot[r];return c?e.jsxs("div",{ref:a,className:"fixed z-[9998] overflow-y-auto",style:{bottom:80,right:24,width:340,maxHeight:"60vh",background:"var(--bg-card)",border:"1px solid var(--border)",borderRadius:12,boxShadow:"0 8px 32px rgba(0,0,0,0.25)",padding:20},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsx("div",{className:"text-[14px] font-bold text-text",children:c.title}),e.jsx("button",{onClick:s,className:"text-text-faint hover:text-text transition-colors p-0.5","aria-label":"Close help panel",children:e.jsx(Ze,{className:"w-4 h-4",strokeWidth:1.75})})]}),e.jsx("div",{className:"space-y-2.5",children:c.steps.map((d,n)=>e.jsxs("div",{className:"flex gap-2.5 items-start",children:[e.jsx("span",{className:"w-5 h-5 rounded-full bg-accent text-white text-[10px] font-bold flex items-center justify-center flex-shrink-0",children:n+1}),e.jsx("span",{className:"text-[12px] text-text-dim leading-[1.7]",children:d})]},n))})]}):null}function ka({title:r,subtitle:s,helpLink:a,children:c}){const[d,n]=i.useState(!1),p=i.useCallback(()=>{n(x=>!x)},[]),u=i.useCallback(()=>{n(!1)},[]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"sticky top-0 z-10 border-b border-border -mx-10 mb-5",style:{padding:"28px 40px 20px",background:"var(--bg-white, var(--bg-main))"},children:[e.jsx("h2",{className:"font-bold text-text",style:{fontSize:"clamp(18px, 1.8vw + 0.5rem, 22px)",marginBottom:"2px"},children:r}),s&&e.jsxs("p",{className:"text-[13px] text-text-dim",children:[s,a&&e.jsxs(e.Fragment,{children:[" ",e.jsx("button",{type:"button",onClick:p,className:"text-accent hover:underline page-how-link",children:"How this works →"})]})]}),c]}),e.jsx(rt,{helpId:d&&a||null,onClose:u})]})}function fa({jobId:r,onClose:s}){const[a,c]=i.useState(null),[d,n]=i.useState(!1),[p,u]=i.useState(null),x=i.useCallback(async l=>{n(!0),u(null);try{const{data:k,error:b}=await j.from("ats_jobs").select("greenhouse_id, title, company_name, location, salary_min, salary_max, salary_currency, salary_rate, ats_source, url, content, created_at, updated_at").eq("greenhouse_id",l).single();if(b)throw b;c(k)}catch(k){u(k?.message||"Failed to load job")}finally{n(!1)}},[]);i.useEffect(()=>{r?x(r):c(null)},[r,x]);const m=l=>{if(!l.salary_min&&!l.salary_max)return null;const k=l.salary_currency||"USD",b=w=>new Intl.NumberFormat("en-US",{style:"currency",currency:k,maximumFractionDigits:0}).format(w);return l.salary_min&&l.salary_max?`${b(l.salary_min)} – ${b(l.salary_max)}${l.salary_rate?` / ${l.salary_rate}`:""}`:l.salary_min?`${b(l.salary_min)}+${l.salary_rate?` / ${l.salary_rate}`:""}`:l.salary_max?`Up to ${b(l.salary_max)}${l.salary_rate?` / ${l.salary_rate}`:""}`:null};return e.jsxs(A,{open:!!r,onClose:s,title:a?.title||"Job Details",size:"xl",footer:a?.url?e.jsx("a",{href:a.url,target:"_blank",rel:"noopener noreferrer",className:"px-4 py-2 bg-accent text-white rounded-md text-sm font-medium hover:opacity-90",children:"View on Career Page"}):void 0,children:[d&&e.jsx("div",{className:"flex items-center justify-center py-12",children:e.jsx("div",{className:"w-6 h-6 border-2 border-accent border-t-transparent rounded-full animate-spin"})}),p&&e.jsx("div",{className:"text-red-500 text-sm py-4",children:p}),a&&!d&&e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex flex-wrap gap-2 text-sm text-text-dim",children:[a.company_name&&e.jsx("span",{className:"font-medium text-text",children:a.company_name}),a.location&&e.jsxs("span",{children:["· ",a.location]})]}),m(a)&&e.jsx("div",{className:"text-sm font-medium text-accent",children:m(a)}),e.jsxs("div",{className:"flex gap-4 text-xs text-text-faint",children:[a.created_at&&e.jsxs("span",{children:["Posted: ",new Date(a.created_at).toLocaleDateString()]}),a.updated_at&&e.jsxs("span",{children:["Updated: ",new Date(a.updated_at).toLocaleDateString()]})]}),a.content&&e.jsxs("div",{className:"border-t border-border pt-4",children:[e.jsx("h3",{className:"text-sm font-semibold text-text mb-2",children:"Job Description"}),e.jsx("div",{className:"text-sm text-text-dim leading-relaxed prose prose-sm max-w-none",dangerouslySetInnerHTML:{__html:a.content}})]})]})]})}const S={company:"Browse Companies",title:"Browse Job Titles",skills:"Browse Skills",dept:"Browse Departments",level:"Browse Levels",location:"Browse Locations",jd:"Browse JD Keywords"};function ga({open:r,onClose:s,onSelect:a,dimension:c="company",levelHierarchy:d}){const[n,p]=i.useState([]),[u,x]=i.useState(""),[m,l]=i.useState("all"),[k,b]=i.useState(!1),[w,q]=i.useState("");i.useEffect(()=>{r&&(b(!0),p([]),x(""),(async()=>{try{if(c==="level"){const f=d&&d.length>0?d.map(_=>_.label):["Intern","Entry","Junior","Mid","Senior","Lead","Manager","Director","VP","Executive"];p(f.map(_=>({name:_,jobCount:0,status:"neutral"}))),b(!1);return}const o={title:"title",skills:"skill",dept:"dept"};if(o[c]){const{data:f,error:_}=await j.rpc("fn_filter_browser_top",{p_dimension:o[c],p_us_only:!1,p_limit:500});!_&&f?.length&&p(f.map($=>({name:$.value.split(" ").map(C=>C.charAt(0).toUpperCase()+C.slice(1)).join(" "),jobCount:$.job_count,status:"neutral"}))),b(!1);return}const{data:y,error:h}=await j.rpc("fn_filter_browser_top",{p_dimension:"company",p_us_only:!1,p_limit:1e3});!h&&y?.length&&p(y.map(f=>({name:f.value,jobCount:f.job_count,status:"neutral"})))}catch(o){console.error("[Browse]",o)}b(!1)})())},[r,c]);const H=i.useCallback(o=>{p(y=>y.map(h=>h.name===o?{...h,status:h.status==="neutral"?"included":h.status==="included"?"excluded":"neutral"}:h))},[]),M=i.useMemo(()=>{let o=n;return u&&(o=o.filter(y=>y.name.toLowerCase().includes(u.toLowerCase()))),m==="included"&&(o=o.filter(y=>y.status==="included")),m==="excluded"&&(o=o.filter(y=>y.status==="excluded")),o},[n,u,m]),N=i.useMemo(()=>{const o={};return M.forEach(y=>{const h=(y.name[0]||"#").toUpperCase();o[h]||(o[h]=[]),o[h].push(y)}),o},[M]),E=i.useMemo(()=>{const o="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split(""),y=new Set(Object.keys(N));return o.map(h=>({letter:h,has:y.has(h)}))},[N]),V=S[c]||"Browse",g=n.filter(o=>o.status==="included").length,v=n.filter(o=>o.status==="excluded").length;return r?e.jsx(A,{open:r,onClose:s,title:S[c]||"Browse",size:"lg",children:e.jsxs("div",{className:"w-[90vw] max-w-[600px] max-h-[80vh] flex flex-col",children:[e.jsxs("div",{className:"px-5 py-4 border-b border-border flex-shrink-0",children:[e.jsx("div",{className:"text-[15px] font-bold text-text mb-3",children:V}),e.jsxs("div",{className:"flex items-center gap-2 flex-wrap",children:[e.jsx("input",{type:"text",value:u,onChange:o=>x(o.target.value),placeholder:"Search companies…",className:"flex-1 min-w-[200px] px-3 py-2 rounded-lg border border-border bg-bg-input text-[13px] text-text focus:border-accent focus:outline-none"}),e.jsx("div",{className:"flex gap-0 rounded-lg overflow-hidden border border-border",children:["all","included","excluded"].map(o=>e.jsx("button",{onClick:()=>l(o),className:`px-3 py-1.5 text-[12px] font-semibold transition-all ${m===o?"bg-accent text-white":"bg-bg-input text-text-dim"}`,children:o==="all"?"All":o==="included"?`✓ (${g})`:`✕ (${v})`},o))})]})]}),e.jsx("div",{className:"flex flex-wrap gap-[3px] px-5 py-2 border-b border-border flex-shrink-0",children:E.map(({letter:o,has:y})=>e.jsx("button",{onClick:()=>{y&&(q(o),document.getElementById(`cb-${o}`)?.scrollIntoView({behavior:"smooth",block:"start"}))},className:`text-[11px] font-bold px-1.5 py-0.5 rounded transition-all ${y?w===o?"bg-accent text-white":"text-accent hover:bg-accent/10 cursor-pointer":"text-text-faint opacity-35"}`,children:o},o))}),e.jsx("div",{className:"flex-1 overflow-y-auto px-5 py-2",style:{maxHeight:"55vh"},children:k?e.jsx("div",{className:"text-center py-12 text-text-faint text-[13px]",children:"Loading companies…"}):M.length===0?e.jsx("div",{className:"text-center py-12 text-text-faint text-[13px]",children:"No companies found"}):Object.entries(N).sort(([o],[y])=>o.localeCompare(y)).map(([o,y])=>e.jsxs("div",{className:"mb-5",id:`cb-${o}`,children:[e.jsx("div",{className:"text-[18px] font-bold text-accent py-1 pb-1.5 border-b border-border mb-2 sticky top-0 bg-bg-card z-[2]",children:o}),y.map(h=>e.jsxs("div",{className:"flex items-center gap-2.5 px-2.5 py-[7px] rounded-lg cursor-pointer text-[13px] hover:bg-bg-hover transition-colors",onClick:()=>H(h.name),children:[e.jsx("div",{className:`w-[22px] h-[22px] rounded flex items-center justify-center flex-shrink-0 text-[12px] border-[1.5px] transition-all ${h.status==="included"?"bg-green border-green text-white":h.status==="excluded"?"bg-red border-red text-white":"border-border"}`,children:h.status==="included"?"✓":h.status==="excluded"?"✕":""}),e.jsx("span",{className:"flex-1 font-medium text-text",children:h.name}),e.jsxs("span",{className:"text-[11px] text-text-faint whitespace-nowrap",children:[h.jobCount," job",h.jobCount!==1?"s":""]})]},h.name))]},o))}),(g>0||v>0)&&e.jsxs("div",{className:"px-5 py-3 border-t border-border flex items-center gap-2 flex-shrink-0",children:[e.jsxs("span",{className:"text-[12px] font-semibold text-text-dim",children:[g>0&&e.jsxs("span",{className:"text-green",children:[g," included"]}),g>0&&v>0&&" · ",v>0&&e.jsxs("span",{className:"text-red",children:[v," excluded"]})]}),e.jsx("button",{onClick:()=>{const o=n.filter(h=>h.status==="included").map(h=>h.name),y=n.filter(h=>h.status==="excluded").map(h=>h.name);o.length&&a?.(o,"include"),y.length&&a?.(y,"exclude"),s()},className:"ml-auto px-4 py-2 rounded-lg bg-accent text-white text-[12px] font-semibold",children:"Apply Selections"})]})]})}):null}export{Vt as $,lt as A,mt as B,ma as C,$t as D,Ct as E,St as F,qt as G,ka as H,na as I,fa as J,ga as K,Bt as L,Jt as M,gt as N,Wt as O,Gt as P,pa as Q,_t as R,Qt as S,it as T,ya as U,Pt as V,ha as W,Ze as X,sa as Y,ua as Z,ra as _,Mt as a,ba as a0,It as a1,kt as a2,At as a3,Ht as a4,Et as a5,vt as a6,wt as a7,Nt as a8,ut as a9,yt as aa,Xt as ab,bt as ac,Dt as ad,pt as b,xt as c,da as d,aa as e,ca as f,oa as g,ft as h,ea as i,jt as j,ht as k,Rt as l,Ot as m,Kt as n,ia as o,xa as p,Zt as q,Ut as r,ta as s,zt as t,Ft as u,dt as v,Lt as w,la as x,Tt as y,Yt as z};
