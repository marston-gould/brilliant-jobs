const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FeedPage-CkaUWbUm.js","assets/react-vendor-DGWi3gCj.js","assets/design-system-Dc7q8k0N.js","assets/providers-BeAkJWdE.js","assets/router-BaE0turN.js","assets/react-dom-Dsjvxb5P.js","assets/GetStartedPage-ByldPQ4D.js","assets/PipelinePage-BaKdUZax.js","assets/KeywordsPage-CYCUkLBt.js","assets/ResumesPage-DsE-WjeM.js","assets/ApplicationsPage-DVw5BYrj.js","assets/StatsPage-BfxlKbmE.js","assets/TuningPage-1lewj0ud.js","assets/BillingPage-bhUv4Qjj.js","assets/SettingsPage-CQwtFMh0.js","assets/IntegrationsPage-CjZ1Slr_.js","assets/ChatPage-CD0XWhji.js","assets/ReferralsPage-CFRQdE2e.js","assets/InterviewPrepPage-DYBQ_OO6.js","assets/NotificationsPage-DFGdTdvX.js","assets/admin-pages-DlQUicte.js"])))=>i.map(i=>d[i]);
import{a as t,j as e}from"./react-vendor-DGWi3gCj.js";import{c as J}from"./react-dom-Dsjvxb5P.js";import{u as K,a as W,N as S,O as E,b as _,c as G,R as F}from"./router-BaE0turN.js";import{u as z,b as Y,s as I,D as Z}from"./providers-BeAkJWdE.js";import{T as $}from"./design-system-Dc7q8k0N.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))l(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const p of o.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&l(p)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function l(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();const Q="modulepreload",X=function(a){return"/dist/spa/"+a},C={},i=function(n,s,l){let r=Promise.resolve();if(s&&s.length>0){let p=function(m){return Promise.all(m.map(g=>Promise.resolve(g).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};document.getElementsByTagName("link");const x=document.querySelector("meta[property=csp-nonce]"),b=x?.nonce||x?.getAttribute("nonce");r=p(s.map(m=>{if(m=X(m),m in C)return;C[m]=!0;const g=m.endsWith(".css"),y=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${y}`))return;const f=document.createElement("link");if(f.rel=g?"stylesheet":Q,g||(f.as="script"),f.crossOrigin="",f.href=m,b&&f.setAttribute("nonce",b),document.head.appendChild(f),g)return new Promise((w,N)=>{f.addEventListener("load",w),f.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(p){const x=new Event("vite:preloadError",{cancelable:!0});if(x.payload=p,window.dispatchEvent(x),!x.defaultPrevented)throw p}return r.then(p=>{for(const x of p||[])x.status==="rejected"&&o(x.reason);return n().catch(o)})};/**
