const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FeedPage-C5a0h_Ch.js","assets/react-vendor-DGWi3gCj.js","assets/design-system-FUzmWWpK.js","assets/providers-BeAkJWdE.js","assets/router-BaE0turN.js","assets/react-dom-Dsjvxb5P.js","assets/GetStartedPage-CDMhLV-_.js","assets/PipelinePage-BFoHpVee.js","assets/KeywordsPage-CS43xtbK.js","assets/ResumesPage-2V1WsUX7.js","assets/ApplicationsPage-BFqVqqKw.js","assets/StatsPage-Bv8JHR0k.js","assets/TuningPage-CL7z7qER.js","assets/BillingPage-B3817uxO.js","assets/SettingsPage-Cl5RGnwB.js","assets/IntegrationsPage-D_Ez5Qgm.js","assets/ChatPage-C02fvRhU.js","assets/ReferralsPage-BTO7PFu1.js","assets/InterviewPrepPage-CNM8Io4g.js","assets/NotificationsPage-DNAEAnX_.js","assets/admin-pages-PfVa9pLg.js"])))=>i.map(i=>d[i]);
import{a as t,j as e}from"./react-vendor-DGWi3gCj.js";import{c as K}from"./react-dom-Dsjvxb5P.js";import{u as W,a as G,N as S,O as P,b as _,c as J,R as F}from"./router-BaE0turN.js";import{u as z,b as Y,s as I,D as Z}from"./providers-BeAkJWdE.js";import{T as $}from"./design-system-FUzmWWpK.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))c(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const p of o.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&c(p)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function c(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();const Q="modulepreload",X=function(a){return"/dist/spa/"+a},C={},i=function(n,s,c){let r=Promise.resolve();if(s&&s.length>0){let p=function(x){return Promise.all(x.map(g=>Promise.resolve(g).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),b=m?.nonce||m?.getAttribute("nonce");r=p(s.map(x=>{if(x=X(x),x in C)return;C[x]=!0;const g=x.endsWith(".css"),y=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${x}"]${y}`))return;const f=document.createElement("link");if(f.rel=g?"stylesheet":Q,g||(f.as="script"),f.crossOrigin="",f.href=x,b&&f.setAttribute("nonce",b),document.head.appendChild(f),g)return new Promise((k,w)=>{f.addEventListener("load",k),f.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${x}`)))})}))}function o(p){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=p,window.dispatchEvent(m),!m.defaultPrevented)throw p}return r.then(p=>{for(const m of p||[])m.status==="rejected"&&o(m.reason);return n().catch(o)})};/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ke=[["path",{d:"M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z",key:"r04s7s"}]],We=d("star",Ke);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ge=[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]],Je=d("sun",Ge);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fe=[["path",{d:"M16 7h6v6",key:"box55l"}],["path",{d:"m22 7-8.5 8.5-5-5L2 17",key:"1t1m79"}]],Ye=d("trending-up",Fe),Ze=[{label:"",items:[{path:"/app/get-started",label:"Get Started",Icon:We,dot:!0,dotColor:"var(--green)"}]},{label:"SEARCH",items:[{path:"/app/feed",label:"Jobs Feed",Icon:q,dot:!0,dotColor:"var(--green)",badge:!0},{path:"/app/tuning",label:"Search Tuning",Icon:Ue,indent:!0,dot:!0,dotColor:"var(--warm)"},{path:"/app/resumes",label:"Resumes",Icon:_e,dot:!0,dotColor:"#ef4444",badge:!0}]},{label:"APPLICATIONS",items:[{path:"/app/applications",label:"My Applications",Icon:oe,dot:!0,dotColor:"#ef4444",badge:!0},{path:"/app/interview-prep",label:"Interview Prep",Icon:we}]},{label:"INTELLIGENCE",items:[{path:"/app/stats",label:"Stats",Icon:xe}]},{label:"ACCOUNT",items:[{path:"/app/settings",label:"Settings",Icon:De},{path:"/app/billing",label:"Subscription",Icon:be},{path:"/app/notifications",label:"Notifications",Icon:D}]}],Qe=[{path:"/app/admin/overview",label:"Overview",Icon:Pe},{path:"/app/admin/jobs",label:"Jobs",Icon:q},{path:"/app/admin/cron",label:"Cron",Icon:ge},{path:"/app/admin/content",label:"Content",Icon:Te},{path:"/app/admin/seo",label:"SEO",Icon:$e},{path:"/app/admin/notifications",label:"Notifications",Icon:D},{path:"/app/admin/agents",label:"Agents",Icon:pe},{path:"/app/admin/monitoring",label:"Monitoring",Icon:Ye},{path:"/app/admin/killswitch",label:"Kill Switch",Icon:Le},{path:"/app/admin/compliance",label:"Compliance",Icon:Be}],B="bj-theme",M={light:"Light",dark:"Dark",auto:"Auto"},Xe={light:Je,dark:Re,auto:Ie},N=["light","dark","auto"];function et(){try{const a=localStorage.getItem(B);if(a==="light"||a==="dark"||a==="auto")return a}catch{}return"auto"}function L(a){document.documentElement.setAttribute("data-theme",a);try{localStorage.setItem(B,a)}catch{}}const O=["#6366f1","#8b5cf6","#ec4899","#f43f5e","#f97316","#eab308","#22c55e","#14b8a6","#06b6d4","#3b82f6"];function tt(a){const n=Array.from(a).reduce((s,c)=>(s<<5)-s+c.charCodeAt(0)|0,0);return O[Math.abs(n)%O.length]??"#6366f1"}function at(a,n){return(n||a).charAt(0).toUpperCase()}function nt(){const a=z(),n=Y(),s=W(),c=G(),[r,o]=t.useState(null),[p,m]=t.useState(et),[b,x]=t.useState(0),[g,y]=t.useState({}),f=c.pathname.startsWith("/app/admin"),k=r?.role==="admin";t.useEffect(()=>{try{const u=window.posthog;u?.capture&&u.capture("$pageview",{$current_url:window.location.href})}catch{}},[c.pathname]),t.useEffect(()=>(a.getCurrentUser().then(o).catch(()=>o(null)),a.onAuthChange(o)),[a]),t.useEffect(()=>{n.billing.getBalance().then(x).catch(()=>x(0))},[n]),t.useEffect(()=>{if(!r)return;const u=async()=>{try{const h={},j=await n.stats.getJobCounts();j&&(h["/app/feed"]=j.total_open??0);const E=await n.resumes.getAll();h["/app/resumes"]=Array.isArray(E)?E.length:0;const A=await n.applications.getQueue();h["/app/applications"]=Array.isArray(A)?A.length:0,y(h)}catch{}};u();const v=setInterval(u,6e4);return()=>clearInterval(v)},[r,n]),t.useEffect(()=>{L(p);const u=window.matchMedia("(prefers-color-scheme: dark)"),v=()=>{p==="auto"&&L("auto")};return u.addEventListener("change",v),()=>u.removeEventListener("change",v)},[p]);const w=t.useCallback(()=>{m(u=>N[(N.indexOf(u)+1)%N.length]??"auto")},[]),H=t.useCallback(async()=>{try{await a.signOut(),s("/")}catch{}},[a,s]),U=Xe[p];return e.jsx($,{children:e.jsxs("div",{className:"flex h-screen",children:[e.jsxs("nav",{"aria-label":"Main navigation",className:"flex flex-col h-full w-[var(--nav-w,240px)] bg-[var(--nav-bg)] flex-shrink-0 overflow-y-auto overflow-x-hidden",children:[e.jsx("div",{className:"px-4 pt-5 pb-4",children:e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"w-[30px] h-[30px] rounded-lg bg-white flex items-center justify-center text-[var(--nav-bg)] font-extrabold text-sm flex-shrink-0",children:"B"}),e.jsxs("div",{children:[e.jsx("div",{className:"font-bold text-[16px] text-white leading-tight",children:"Brilliant Jobs"}),e.jsxs("div",{className:"text-[11px] text-[var(--nav-text)]",children:["Dashboard ",e.jsx("span",{className:"text-[9px]",children:"v10.71"})]})]})]})}),e.jsxs("div",{className:"flex-1 px-2 space-y-0.5",children:[(f?[{label:"ADMIN",items:Qe}]:Ze).map((u,v)=>e.jsxs("div",{children:[u.label&&e.jsx("div",{className:"px-3.5 pt-3 pb-1.5 mt-2 text-[10px] font-bold tracking-[1.5px] text-white/30 uppercase select-none",children:u.label}),u.items.map(h=>e.jsxs(S,{to:h.path,className:({isActive:j})=>`
                    flex items-center gap-3 py-2.5 rounded-lg transition-colors text-[13.5px] font-medium mb-0.5
                    ${j?"bg-[var(--nav-bg-active)] text-white":"text-[var(--nav-text)] hover:bg-[var(--nav-bg-active)]"}
                    ${h.indent?"pl-[34px] pr-3.5 text-[12px]":"px-3.5"}
                  `,children:[e.jsx(h.Icon,{className:"w-[18px] h-[18px] flex-shrink-0 opacity-80",strokeWidth:1.75}),e.jsx("span",{className:"flex-1",children:h.label}),h.badge&&(g[h.path]??0)>0&&e.jsx("span",{className:"text-[11px] font-semibold bg-white/15 text-white px-2 py-0.5 rounded-lg tabular-nums leading-none ml-auto",children:(g[h.path]??0)>999?"999+":g[h.path]}),h.dot&&e.jsx("span",{className:"w-2 h-2 rounded-full flex-shrink-0 ml-auto",style:{background:h.badge&&g[h.path]!==void 0?(g[h.path]??0)>0?"var(--green, #22c55e)":"#ef4444":h.dotColor||"var(--green, #22c55e)"}})]},h.path+h.label)),u.label==="INTELLIGENCE"&&!f&&e.jsxs("a",{href:"/blog",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-colors text-[13.5px] font-medium text-[var(--nav-text)] hover:bg-[var(--nav-bg-active)] mb-0.5",children:[e.jsx(ce,{className:"w-[18px] h-[18px] flex-shrink-0 opacity-80",strokeWidth:1.75}),e.jsx("span",{children:"Insights"}),e.jsx(ve,{className:"w-[10px] h-[10px] opacity-40 ml-0.5",strokeWidth:1.75})]})]},u.label||v)),k&&!f&&e.jsxs(S,{to:"/app/admin",className:"flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-colors text-[13.5px] font-medium text-[var(--nav-text)] hover:bg-[var(--nav-bg-active)] mb-0.5",children:[e.jsx(Ae,{className:"w-[18px] h-[18px] flex-shrink-0 opacity-80",strokeWidth:1.75}),e.jsx("span",{children:"Admin"})]})]}),e.jsxs("div",{className:"px-3 pb-3 mt-auto space-y-2",children:[r&&e.jsxs("div",{className:"flex items-center gap-2.5 px-1 py-2",children:[e.jsx("div",{className:"w-8 h-8 rounded-full flex items-center justify-center text-white text-[13px] font-bold flex-shrink-0",style:{backgroundColor:tt(r.email)},children:at(r.email,r.display_name)}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("div",{className:"text-[12px] text-white/70 truncate",children:r.email}),e.jsx("div",{className:"text-[10px] font-semibold tracking-wide uppercase",style:{color:r.role==="admin"?"#f97316":"rgba(255,255,255,0.4)"},children:r.role==="admin"?"ADMIN":r.tier.toUpperCase()})]})]}),e.jsxs("div",{className:"flex items-center gap-0",children:[e.jsxs("div",{className:"flex-1 flex items-center gap-1.5 px-2.5 py-1.5 rounded-md bg-white/[0.06] cursor-pointer hover:bg-white/10 transition-colors",onClick:()=>s("/app/billing"),title:"Click to purchase credits",children:[e.jsx("span",{className:"text-[9px] font-bold text-white/40 bg-white/10 px-1 py-0.5 rounded tracking-wide leading-none",children:"CR"}),e.jsx("span",{className:`text-[13px] font-semibold tabular-nums ${b>0?"text-[var(--green)]":"text-white/70"}`,children:b}),e.jsx("span",{className:"text-[10px] text-white/40",children:"credits"})]}),e.jsxs("button",{onClick:w,className:"flex items-center gap-1.5 px-2.5 py-2 rounded-md hover:bg-white/10 transition-colors","aria-label":`Theme: ${p}`,title:`Theme: ${M[p]}`,children:[e.jsx(U,{className:"w-3.5 h-3.5 text-white/50",strokeWidth:1.75}),e.jsx("span",{className:"text-[10px] text-white/50",children:M[p]})]})]}),e.jsx("button",{onClick:H,className:"w-full py-2 rounded-md text-[12px] font-medium text-white/60 hover:text-white hover:bg-white/10 transition-colors border border-white/10",children:"Log Out"}),e.jsxs("div",{className:"text-[10px] text-white/30 text-center",children:["© ",new Date().getFullYear()," Brilliant Jobs"]})]})]}),e.jsx("main",{id:"main-content",role:"main",className:"flex-1 overflow-y-auto bg-[var(--bg-main)] px-10 py-7",children:e.jsx(P,{})})]})})}function st(){const[a,n]=t.useState("loading");return t.useEffect(()=>{let s=!1;I.auth.getSession().then(({data:r})=>{s||n(r?.session?.user?"authenticated":"unauthenticated")}).catch(()=>{s||n("unauthenticated")});const{data:{subscription:c}}=I.auth.onAuthStateChange((r,o)=>{s||n(o?.user?"authenticated":"unauthenticated")});return()=>{s=!0,c.unsubscribe()}},[]),a==="loading"?e.jsx("div",{className:"flex items-center justify-center h-screen bg-bg-main",children:e.jsxs("div",{className:"flex flex-col items-center gap-3",children:[e.jsx("div",{className:"w-8 h-8 border-2 border-accent border-t-transparent rounded-full animate-spin"}),e.jsx("p",{className:"text-sm text-text-dim",children:"Loading..."})]})}):a==="unauthenticated"?(window.location.href="/",null):e.jsx(P,{})}function rt(){const a=z(),[n,s]=t.useState("loading");return t.useEffect(()=>{let c=!1;return a.getCurrentUser().then(r=>{c||s(r?.role==="admin"?"admin":"denied")}).catch(()=>{c||s("denied")}),()=>{c=!0}},[a]),n==="loading"?e.jsx("div",{className:"flex items-center justify-center h-full",children:e.jsx("div",{className:"w-6 h-6 border-2 border-accent border-t-transparent rounded-full animate-spin"})}):n==="denied"?e.jsx(_,{to:"/app/feed",replace:!0}):e.jsx(P,{})}const ot=t.lazy(()=>i(()=>import("./FeedPage-C5a0h_Ch.js"),__vite__mapDeps([0,1,2,3,4,5]))),it=t.lazy(()=>i(()=>import("./GetStartedPage-CDMhLV-_.js"),__vite__mapDeps([6,1,3,4,5,2]))),lt=t.lazy(()=>i(()=>import("./PipelinePage-BFoHpVee.js"),__vite__mapDeps([7,1,2,3]))),ct=t.lazy(()=>i(()=>import("./KeywordsPage-CS43xtbK.js"),__vite__mapDeps([8,1,2,3]))),dt=t.lazy(()=>i(()=>import("./ResumesPage-2V1WsUX7.js"),__vite__mapDeps([9,1,2,3,4,5]))),pt=t.lazy(()=>i(()=>import("./ApplicationsPage-BFqVqqKw.js"),__vite__mapDeps([10,1,2,3,5,4]))),ht=t.lazy(()=>i(()=>import("./StatsPage-Bv8JHR0k.js"),__vite__mapDeps([11,1,2,3,5,4]))),ut=t.lazy(()=>i(()=>import("./TuningPage-CL7z7qER.js"),__vite__mapDeps([12,1,2,3,5,4]))),xt=t.lazy(()=>i(()=>import("./BillingPage-B3817uxO.js"),__vite__mapDeps([13,1,2,3,5,4]))),mt=t.lazy(()=>i(()=>import("./SettingsPage-Cl5RGnwB.js"),__vite__mapDeps([14,1,2,3,5,4]))),gt=t.lazy(()=>i(()=>import("./IntegrationsPage-D_Ez5Qgm.js"),__vite__mapDeps([15,1,2,3]))),ft=t.lazy(()=>i(()=>import("./ChatPage-C02fvRhU.js"),__vite__mapDeps([16,1,2,3]))),bt=t.lazy(()=>i(()=>import("./ReferralsPage-BTO7PFu1.js"),__vite__mapDeps([17,1,2,3]))),yt=t.lazy(()=>i(()=>import("./InterviewPrepPage-CNM8Io4g.js"),__vite__mapDeps([18,1,2,3,5,4]))),vt=t.lazy(()=>i(()=>import("./NotificationsPage-DNAEAnX_.js"),__vite__mapDeps([19,1,2,3,5,4]))),jt=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.O),__vite__mapDeps([20,1,2,3]))),_t=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.J),__vite__mapDeps([20,1,2,3]))),kt=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.C),__vite__mapDeps([20,1,2,3]))),wt=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.a),__vite__mapDeps([20,1,2,3]))),Nt=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.S),__vite__mapDeps([20,1,2,3]))),Pt=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.N),__vite__mapDeps([20,1,2,3]))),Et=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.A),__vite__mapDeps([20,1,2,3]))),At=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.M),__vite__mapDeps([20,1,2,3]))),St=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.K),__vite__mapDeps([20,1,2,3]))),It=t.lazy(()=>i(()=>import("./admin-pages-PfVa9pLg.js").then(a=>a.b),__vite__mapDeps([20,1,2,3])));function l({label:a}){return e.jsxs("div",{className:"p-6 max-w-6xl mx-auto",children:[e.jsxs("div",{className:"space-y-2 mb-6",children:[e.jsx("div",{className:"animate-pulse rounded bg-gray-200/50 dark:bg-gray-700/30 h-7 w-48"}),e.jsx("div",{className:"animate-pulse rounded bg-gray-200/50 dark:bg-gray-700/30 h-4 w-72"})]}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4 mb-6",children:[1,2,3,4].map(n=>e.jsxs("div",{className:"p-4 rounded-lg border border-gray-200/50 dark:border-gray-700/30",children:[e.jsx("div",{className:"animate-pulse rounded bg-gray-200/50 dark:bg-gray-700/30 h-3 w-16 mb-2"}),e.jsx("div",{className:"animate-pulse rounded bg-gray-200/50 dark:bg-gray-700/30 h-8 w-24"})]},n))}),e.jsx("div",{className:"space-y-3",children:[1,2,3].map(n=>e.jsxs("div",{className:"p-4 rounded-lg border border-gray-200/50 dark:border-gray-700/30",children:[e.jsx("div",{className:"animate-pulse rounded bg-gray-200/50 dark:bg-gray-700/30 h-4 w-3/4 mb-2"}),e.jsx("div",{className:"animate-pulse rounded bg-gray-200/50 dark:bg-gray-700/30 h-3 w-1/2"})]},n))}),e.jsxs("p",{className:"sr-only",children:["Loading ",a,"…"]})]})}function Ct(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"feed"}),children:e.jsx(ot,{})})}function Rt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"get started"}),children:e.jsx(it,{})})}function Mt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"pipeline"}),children:e.jsx(lt,{})})}function Lt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"readiness"}),children:e.jsx(ct,{})})}function Ot(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"resumes"}),children:e.jsx(dt,{})})}function Tt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"applications"}),children:e.jsx(pt,{})})}function zt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"stats"}),children:e.jsx(ht,{})})}function $t(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"tuning"}),children:e.jsx(ut,{})})}function Vt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"billing"}),children:e.jsx(xt,{})})}function Dt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"settings"}),children:e.jsx(mt,{})})}function qt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"integrations"}),children:e.jsx(gt,{})})}function Bt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"chat"}),children:e.jsx(ft,{})})}function Ht(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"referrals"}),children:e.jsx(bt,{})})}function Ut(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"interview prep"}),children:e.jsx(yt,{})})}function Kt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"notifications"}),children:e.jsx(vt,{})})}function Wt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"overview"}),children:e.jsx(jt,{})})}function Gt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"jobs"}),children:e.jsx(_t,{})})}function Jt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"cron"}),children:e.jsx(kt,{})})}function Ft(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"content"}),children:e.jsx(wt,{})})}function Yt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"seo"}),children:e.jsx(Nt,{})})}function Zt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"notifications"}),children:e.jsx(Pt,{})})}function Qt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"agents"}),children:e.jsx(Et,{})})}function Xt(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"monitoring"}),children:e.jsx(At,{})})}function ea(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"killswitch"}),children:e.jsx(St,{})})}function ta(){return e.jsx(t.Suspense,{fallback:e.jsx(l,{label:"compliance"}),children:e.jsx(It,{})})}const aa=[{path:"/app",element:e.jsx(st,{}),children:[{element:e.jsx(nt,{}),children:[{index:!0,element:e.jsx(_,{to:"get-started",replace:!0})},{path:"get-started",element:e.jsx(Rt,{})},{path:"feed",element:e.jsx(Ct,{})},{path:"pipeline",element:e.jsx(Mt,{})},{path:"keywords",element:e.jsx(Lt,{})},{path:"resumes",element:e.jsx(Ot,{})},{path:"applications",element:e.jsx(Tt,{})},{path:"stats",element:e.jsx(zt,{})},{path:"tuning",element:e.jsx($t,{})},{path:"billing",element:e.jsx(Vt,{})},{path:"settings",element:e.jsx(Dt,{})},{path:"integrations",element:e.jsx(qt,{})},{path:"chat",element:e.jsx(Bt,{})},{path:"referrals",element:e.jsx(Ht,{})},{path:"interview-prep",element:e.jsx(Ut,{})},{path:"notifications",element:e.jsx(Kt,{})},{path:"admin",element:e.jsx(rt,{}),children:[{index:!0,element:e.jsx(_,{to:"overview",replace:!0})},{path:"overview",element:e.jsx(Wt,{})},{path:"jobs",element:e.jsx(Gt,{})},{path:"cron",element:e.jsx(Jt,{})},{path:"content",element:e.jsx(Ft,{})},{path:"seo",element:e.jsx(Yt,{})},{path:"notifications",element:e.jsx(Zt,{})},{path:"agents",element:e.jsx(Qt,{})},{path:"monitoring",element:e.jsx(Xt,{})},{path:"killswitch",element:e.jsx(ea,{})},{path:"compliance",element:e.jsx(ta,{})}]},{path:"*",element:e.jsx(_,{to:"feed",replace:!0})}]}]}];function na(){return J(aa)}(function(){const n=window.location.hash?.replace("#",""),s=window.location.pathname;n&&(s==="/dashboard"||s==="/dashboard.html"||s==="/admin"||s==="/admin.html")&&["feed","pipeline","keywords","resumes","applications","stats","billing","settings","tuning","integrations","chat","referrals"].includes(n)&&window.history.replaceState(null,"",`/app/${n}`),(s==="/dashboard"||s==="/dashboard.html")&&!n&&window.history.replaceState(null,"","/app/feed"),(s==="/admin"||s==="/admin.html")&&!n&&window.history.replaceState(null,"","/app/admin/overview")})();const sa=na();function ra(){return e.jsx(t.StrictMode,{children:e.jsx(Z,{children:e.jsx($,{children:e.jsx(F,{router:sa})})})})}const T=document.getElementById("spa-root");T?K.createRoot(T).render(e.jsx(ra,{})):console.error("[SPA] #spa-root not found — React app cannot mount.");export{D as B,_e as F,Te as P,Ue as S,Ye as T,i as _,$e as a,d as c};
//# sourceMappingURL=app-BYZdTR4J.js.map
