(function() {
  "use strict";
  var churnQuestions = [
    { id: "outcome", q: "First things first \u2014 did you land a job?", sub: "No judgment either way. We're just rooting for you.", type: "choice", opts: ["Yes! I'm employed now \u{1F389}", "No \u2014 still searching", "I'm taking a break from searching", "I'm switching to a different approach"] },
