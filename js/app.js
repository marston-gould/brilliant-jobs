...
window.switchSettingsTab = function(tab) {
  ...
  var rulesContent = document.getElementById('settings-content-rules');
  var notifsContent = document.getElementById('settings-content-notifications');
  if (rulesContent) rulesContent.style.display = tab === 'rules' ? 'block' : 'none';
  if (notifsContent) notifsContent.style.display = tab === 'notifications' ? 'block' : 'none';
};
