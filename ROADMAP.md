...
| CREDIT-TIER-001 | Credit Tier Model — 3-tier credit system: Free (1 lifetime use per paid feature), Starter ($20/mo, 100 credits included, $0.15 PAYG), Pro ($40/mo, 300 credits included, $0.10 PAYG). Migration v8.48: starter plan row, free_tier_feature_usage table (UNIQUE user+feature for idempotent 1-use gate), check_entitlement rewritten to route free users through lifetime-use gate before credit debit, record_free_tier_use function. score-resume EF: isPro expanded to include starter, isFree gate checks entitlement before work, records use after success. | 1-2h | 🔲 | Needs: migration push, score-resume EF redeploy, rewrite-resume-extension EF same treatment. |
