...
| SPA-CUT-3 | All 14 remaining hooks — Bridge Elimination (batch transform). Settings (5), Tuning (6), Integrations (6), Chat (6), Referrals (3), Admin Overview (3), Jobs (3), Content (3), SEO (4), Cron (4), Agents (3), Monitoring (3), Kill Switch (4), Compliance (5) = 58 window refs → 0. Python batch transform + manual TS fixes. ALL 22 SPA hooks now standalone. 93 tests. | ✅ | v10.41 |
| SPA-CUT-4 | SUPERSEDED — absorbed into SPA-CUT-3 (batch transform covered Home + Chat + Referral hooks) | N/A | N/A |
| SPA-CUT-5 | SUPERSEDED — absorbed into SPA-CUT-3 (batch transform covered all 9 admin hooks) | N/A | N/A |
