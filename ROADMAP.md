...
| UX-001-S2 | Pagination — Replace infinite scroll with proper page-based pagination (50 per page, page controls, DOM replacement). | 🔲 | Depends on S1. |
| UX-001-S3 | Universal Filter Browser — Extend Browse button to WHAT, SKILLS, DEPT, LEVEL, JD CONTAINS. MV + generic browser component. | 🔲 | Depends on S2. |
