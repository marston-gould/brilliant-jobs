...
| FB-PI-001-S2 | AI Classifier EF — classify-pipeline-signal EF, Anthropic prompt with few-shot examples, structured output parsing, prompt caching, error handling with retry | 🔲 | Depends on S1 |
...
| FB-PI-001-S6 | Settings + Polish + Tests — Pipeline Intelligence settings extensions, notification integration, PostHog event taxonomy, comprehensive test suite | 🔲 | Depends on S4 + S5 |
