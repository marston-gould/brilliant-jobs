...
const extFiles = [
  ...
  'extension/handlers/greenhouse-legacy.js',
  'extension/handlers/greenhouse-react.js',
  'extension/handlers/lever.js',
  'extension/handlers/linkedin-easy-apply.js',
  'extension/utils/resilientDOM.js',
...
test('popup.js — harvest stats catches log warnings', () => {
  const src = readFile('extension/popup.js');
...
test('greenhouse-legacy.js — error report catch logs warning', () => {
  const src = readFile('extension/handlers/greenhouse-legacy.js');
...
test('greenhouse-react.js — error report catch logs warning', () => {
  const src = readFile('extension/handlers/greenhouse-react.js');
...
test('lever.js — error report catch logs warning', () => {
  const src = readFile('extension/handlers/lever.js');
...
test('linkedin-easy-apply.js — selector miss report catch logs warning', () => {
  const src = readFile('extension/handlers/linkedin-easy-apply.js');
...
test('resilientDOM.js — handler error report catch logs warning', () => {
  const src = readFile('extension/utils/resilientDOM.js');
...
test('interceptor.js — parse failure logged with URL context', () => {
  const src = readFile('extension/interceptor.js');
