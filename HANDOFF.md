...
- **CRON-COST-OPT: COMPLETE** — all 12 spec items implemented and deployed. Persistent attribute dictionaries: job_titles_dictionary (344K entries), job_locations_dictionary (65K), job_departments_dictionary (11.5K), job_keywords_dictionary (114K), job_skills_dictionary (82 → growing). DB triggers (trg_populate_dictionaries, trg_populate_ai_dictionaries) auto-populate all 5 dictionaries on every job insert/update. Attributes survive job expiry/archival.
