...
- Product version bumped: `v8.54` → `v8.58` (JS/HTML changes — keywords.js toggleSaveJob rewrite, job-feed.js _feedJobMap, dashboard.html sidebar reorder; all HTML surfaces cache-busted)
...
|---------|---------|-------------|
| **Product (BJ_VERSION)** | **`v8.58`** | **UX-FIX-001: Pipeline save bug + sidebar notification reorder** |
