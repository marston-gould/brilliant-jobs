...
- Product version bumped: `v8.54` → `v8.56` (JS/HTML changes — keywords.js toggleSaveJob rewrite, job-feed.js _feedJobMap, dashboard.html sidebar reorder; all HTML surfaces cache-busted)
...
|---------|---------|-------------|
| **Product (BJ_VERSION)** | **`v8.56`** | **UX-FIX-001: Pipeline save bug + sidebar notification reorder** |
