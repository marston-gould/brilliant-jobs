...
|---------|---------|-------------|
| **Product (BJ_VERSION)** | **`v11.54`** | **Empty feed fix — default query when no filters. 2026-03-20.** |: v11.46–v11.52. Landing page, feedback system, subscription fixes, Lucide audit, ROADMAP sync. 2026-03-20.** |
