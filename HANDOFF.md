...
- **CRON-COST-OPT remaining:** Step 4 (on-demand trigger architecture — enrich-on-demand EF with filter_save/onboarding/job_view webhooks, score-on-demand triggers). Skills dictionary population from enrich-jd-ai output.
