  ...
  return (
    <div className="flex h-screen">
      ...
      <nav aria-label="Main navigation" className="flex flex-col h-full w-[var(--nav-w,240px)] bg-[var(--nav-bg)] flex-shrink-0 overflow-y-auto overflow-x-hidden">
        ...
        {/* Brand — matches legacy: B mark + "Brilliant Jobs" + "Dashboard v10.53" */}
        <div className="px-4 pt-5 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-[var(--nav-text)]">Dashboard <span className="text-[9px]">v10.53</span></div>
            </div>
          </div>
        </div>
