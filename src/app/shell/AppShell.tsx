...
const SECTIONS: NavSection[] = [
  {
    label: '',
    items: [
      { path: '/app/pipeline', label: 'Get Started', Icon: Star },
    ],
  },
  {
    label: 'SEARCH',
      ...
      <nav aria-label="Main navigation" className="flex flex-col h-full w-[var(--nav-w,240px)] bg-[var(--nav-bg)] flex-shrink-0 overflow-y-auto overflow-x-hidden">
        ...
        <div className="px-4 pt-5 pb-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white font-bold text-base flex-shrink-0">B</div>
            <div>
              <div className="font-bold text-[15px] text-white leading-tight">Brilliant Jobs</div>
              <div className="text-[11px] text-white/50">Dashboard</div>
            </div>
          </div>
        </div>
